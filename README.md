...
India's vast network of social welfare schemes (*Yojanas*) often fails to reach its intended low-income and rural beneficiaries due to **fragmented information**, **complex legalistic eligibility criteria**, and **high application friction**. Sankalp Sarathi: Multi-Agent System for Government Scheme Empowerment
